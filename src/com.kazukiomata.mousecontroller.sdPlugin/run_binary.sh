...
export PYTHON_INIT_PATH="${PLUGIN_DIR_PATH}/init"
...
export PLUGIN_CODE_PATH="${PLUGIN_DIR_PATH}/main"
...
export PLUGIN_CODE_VENV_PYHON="${PLUGIN_CODE_VENV_DIR_PATH}/bin/python"
